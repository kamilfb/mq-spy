 ...
 */
public class KinesisScriptManager extends BaseScriptManager
{
	 ...
	 */
	public KinesisScriptManager(final IKBus eventBus, final Executor executor, final KinesisConnection connection)
	{
	...
	{
		final KinesisScriptIO scriptIO = new KinesisScriptIO(connection, script, executor); 
	 ...
	 */
	public void setConnection(final KinesisConnection connection)
	{
