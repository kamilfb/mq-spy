 ...
 *    
 */
package pl.baczkowicz.msgspy.ui.controllers;
...
import pl.baczkowicz.msgspy.ui.ConnectionViewManager;
import pl.baczkowicz.msgspy.ui.ViewManager;
import pl.baczkowicz.msgspy.ui.controlpanel.ConnectionsControlPanelItem;
 ...
 */
public class MsgSpyMainController
{
	private final static Logger logger = LoggerFactory.getLogger(MsgSpyMainController.class);
	...
	public MsgSpyMainController() throws XMLException
	{
	...
	{									
		...
		// TODO: swap these for msg-spy
		controlPanelPaneController.setUserAndConfigItem(new MqttConfigControlPanelItem(configurationManager, eventBus));
		controlPanelPaneController.setConnectionsItem(new ConnectionsControlPanelItem(eventBus));
...
//		final IConnectionController controller = connectionViewManager.getControllerForTab(selectedTab);
//		
//		if (controller != null)
//		{
...
//	public void populateConnectionPanes(final UserInterfaceMqttConnectionDetails connectionDetails, final IConnectionController connectionController)
//	{
...
//	}
	...
	{
//		// Connection tabs
//		for (final IConnectionController controller : connectionViewManager.getConnectionControllers())
//		{
//			controller.getResizeMessageContentMenu().setSelected(resizeMessagePaneMenu.isSelected());
//		}
//		
//		// Offline (message log) tabs
//		for (final IConnectionController controller : connectionViewManager.getOfflineConnectionControllers())
//		{
//			controller.getResizeMessageContentMenu().setSelected(resizeMessagePaneMenu.isSelected());
//		}
	}
	...
	public void setConnectionViewManager(final ConnectionViewManager connectionManager)
	{
...
//	}
	...
	public void updateUiProperties(final PropertyFileLoader uiPropertyFile)
	{
		...
		resizeMessagePaneMenu.setSelected(UiProperties.getResizeMessagePane(configurationManager.getUiPropertyFile()));		
	}
}
